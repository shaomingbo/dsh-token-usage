...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.7
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.7 --source link:$PWD
```
