...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.6
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.6 --source link:$PWD
```
