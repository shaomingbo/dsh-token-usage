...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.10
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.10 --source link:$PWD
```
