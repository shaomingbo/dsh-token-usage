...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.5
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.5 --source link:$PWD
```
