...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.12
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.12 --source link:$PWD
```
