...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.16
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.16 --source link:$PWD
```
