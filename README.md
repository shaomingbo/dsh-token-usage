...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14 status
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14 uninstall
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14 --profile web --source github:shaomingbo/dsh-token-usage#v5.0.14
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14 --help
```
...
```sh
npx --yes github:shaomingbo/dsh-token-usage#v5.0.14 --source link:$PWD
```
