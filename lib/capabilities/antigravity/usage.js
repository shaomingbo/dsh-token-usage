 ...
 *
 * Quota reads answer from the daily generation surface, where consumer usage
 * state actually lives (verified 2026-09-08: prod answers quota requests with
 * 200 + placeholder values — all models remainingFraction=1 and a per-request
 * resetTime of now+5h — which once persisted as a permanent all-0% display).
