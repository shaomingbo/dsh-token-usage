...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PricingTab(props) {
      ...
      const targetModels = [...new Set([...(catalog.value.updated ?? []), ...(catalog.value.bundled ?? []), ...observedModels])].sort()
      ...
      return h('div', { style: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 } },
        ...
        h('div', { style: cardStyle },
          ...
          h('div', { style: { display: 'flex', gap: 6, marginTop: 8 } },
            h('select', { style: selectStyle, value: aliasModel, onChange: (event) => setAliasModel(event.target.value) },
              h('option', { value: '' }, t('selectObservedModel')), ...options(observedModels)),
            h('select', { style: selectStyle, value: aliasCanonical, onChange: (event) => setAliasCanonical(event.target.value) },
              h('option', { value: '' }, t('selectCatalogModel')), ...options(targetModels)),
        ...
        h('div', { style: cardStyle },
          ...
          h('div', { style: { display: 'flex', gap: 6, marginTop: 8 } },
            h('select', { style: selectStyle, value: overrideModel, onChange: (event) => setOverrideModel(event.target.value) },
              h('option', { value: '' }, t('selectObservedModel')), ...options(targetModels)),
            h('input', { style: inputStyle, placeholder: t('overrideInput'), inputMode: 'numeric', value: overrideInput, onChange: (event) => setOverrideInput(event.target.value) }),
            h('input', { style: inputStyle, placeholder: t('overrideOutput'), inputMode: 'numeric', value: overrideOutput, onChange: (event) => setOverrideOutput(event.target.value) }),
