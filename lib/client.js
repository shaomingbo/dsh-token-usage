...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const v3Css = `
      ...
      .tu3-dock-acc { padding: 13px 16px 11px; border-bottom: 1px solid var(--dsw-alias-border-l1, rgba(0,0,0,.04)); cursor: grab; }
    ...
    function DockPanel({ ctx, store, state, t }) {
      ...
      const body = () => {
        ...
        return h('div', { style: { paddingBottom: 18 } },
          h('div', { className: 'tu3-dock-chips', style: { paddingTop: 14 } },
