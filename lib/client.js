    ...
    function AccountsPanel({ ctx, t }) {
      ...
      const save = async (kind) => {
        ...
        try {
          ...
          else if (kind === 'ollamaKey') await setCredential(ctx, 'OLLAMA_API_KEY', drafts.ollamaKey.trim())
          else {
      ...
      return h('section', { className: 'tu3-card', style: { padding: '16px 18px', marginBottom: 12 } },
        ...
        message ? h('p', { style: message === t('credentialSaved') ? mutedStyle : errorStyle }, message) : null,
